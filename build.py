...
TERMS = {"ru": [
    ...
    ("selfhood", r"\bсамост(?:ь|и|ью)\b", "часть твоей минуты, которую сделал ты сам; исток новых идеонов, в импакт не входит"),
    ...
    ("selfhood", r"\bselfhood\b", "the part of your minute that you made yourself; the wellspring of new ideons, not counted as impact"),
