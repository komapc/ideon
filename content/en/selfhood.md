...
**The author.** Makes what was not there: a thought, a melody, a proof, a joke. The rarest job and the most visible.
...
Selfhood and impact are different quantities, and neither follows from the other. Selfhood is production; impact is distribution.

| | Large impact | Small impact |
|---|---|---|
| **Large selfhood** | The founder, the author: the new is born and arrives | The hermit, the diary in a drawer. Kafka and Emily Dickinson in their lifetimes |
| **Small selfhood** | The relay: the announcer, the reteller, the popular account | A minute lived on autopilot |
...
## 4. What the schools do with selfhood

| School | What it does with selfhood | Whose minute it is |
|---|---|---|
