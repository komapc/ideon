...
| Karl Marx | the content of the ideology of the regimes that called themselves Marxist | the USSR as a frame 5 × 10¹⁵ minutes × 0.02–0.05 × share 0.03–0.1 (form and regime go to Lenin and Stalin), 0.1–1 MVt; China 2.6 × 10¹⁶ × 0.02–0.05 × 0.01–0.03, 0.2–1.6 MVt; Eastern Europe 40–200 kVt; the labour movement and Western social democracy 1870–1950 20–100 kVt; the Cold War in the West 8–50 kVt; the humanities 5–30 kVt; Soviet students, the compulsory 300–400 hours of Marxism-Leninism, 5 × 10⁷ people × 0.1–0.3 × share 0.3–0.5, 1–6 kVt, plus school and party study 1–2; Chinese students 1–5 kVt; readers of the Manifesto and Capital outside the regimes 0.5–1 kVt; grief and fear in the famines and the terror −10–80 kVt; monuments, Highgate and Karl-Marx-Stadt 0.1–3 Vt | ± 0.4–3 MVt |
| Vladimir Lenin | October, the party of a new type, the Soviet state | the USSR as a frame for 74 years: 5 × 10¹⁵ subjects' minutes × 0.02–0.05 × share 0.05–0.15 (Stalin takes the rest), 0.2–1.5 MVt; the Leninist party form in China 2.6 × 10¹⁶ × 0.02–0.05 × 0.005–0.015, 0.1–0.8 MVt; Eastern Europe 40–200 kVt; the Lenin cult in school, portraits and slogans 10–50 kVt; the West during the Cold War 4–30 kVt; the texts 1–4 kVt; grief and fear of the terror and the civil war −6–25 kVt; the mausoleum 15–50 Vt; fourteen thousand monuments 0.4–9 Vt | ± 0.4–2.5 MVt |
| Thomas Midgley | leaded gasoline and Freon | 10⁹ people × a whole life × 0.01–0.03 (lead lowers intelligence itself) × 0.2 | − 0.5–10 MVt |
| Gavrilo Princip † | the shot in Sarajevo | 2 × 10⁷ dead × 0.6 Vt × share 0.01–0.3 (the war was ripe, and six assassins stood along the route) | − 0.1–3 MVt |

## Hundreds and tens of kilovitas
...
| Who | For what | Calculation | Estimate |
|---|---|---|---|
| Khufu (Cheops) | the Great Pyramid | builders and subjects in his lifetime 60–400 Vt; the image in people's heads, Egyptology and pyramidology 70–600; visitors and those who live off the pyramid today 50–270; the pharaoh's share is 0.1–0.3 throughout | 0.2–1 kVt |
...
| James Harrison † | plasma donor; the only account computed by the [protocol](protocol.html) | | 1–700 Vt |
| Ken Aston | the yellow and red cards | 10¹¹ minutes × 0.01 × 0.8 | 30 Vt |
| Rosa Parks | the bus seat; Claudette Colvin had done the same nine months earlier | the boycott's account × share 0.1–0.3 | 10–100 Vt |
| Yuri Gagarin | Titov would have been first | | 3–50 Vt |
| Usain Bolt | |  | 10 Vt |
...
| The Great Pyramid | a place | builders 4 × 10⁵ person-years × 0.3–0.5, 1.7–2.8 kVt; the subjects during twenty years of construction 2–5 kVt; those who have lived off it over the last century 0.7–7 kVt; visitors over a century 50–700 Vt; the image in everyone's head 0.2–2 kVt | 2–10 kVt |
...
Under the site's current rules a saved life goes to the rescuer as a whole Vita, and then the summit of the named list is not the founders of religions but a chemist, an agronomist and a virologist. Almost nobody knows Haber or Hilleman, and both stand above Muhammad.
...
Comenius, Braille, Sejong, Guido, Fröbel and Kelly said nothing that people would repeat. They made a form through which other people's minutes pass: the lesson, the script, the alphabet, the staff, the kindergarten, the test with boxes to tick. The degree of a form is small, hundredths, but its reach is all the minutes of everyone who uses it, for centuries. This is why the author of the school timetable stands next to Gutenberg, and the author of a geometry textbook above Tolstoy. Malevich is form literally: almost nobody reads Suprematism or the treatises on non-objectivity, while the square went through his students into the Bauhaus, typography and flat design, where his name is not remembered. Nine tenths of his account is there; the viewers of the square give single Vitas.

There is a limit. Daylight saving time, the keyboard layout, the Gregorian calendar and the standard shipping container touch as many as 10¹⁶ minutes, but their degree is below the smallest division of the protocol, and the honest answer is "from hundreds of Vitas to hundreds of kilovitas". Malcom McLean's container rebuilt world trade and shifted almost nobody's thought: the ruler measures heads, not tons. The Linux kernel is the same container: the most executed code in history, three billion phones, and a degree of zero in the owner's minute; replace the kernel and the minute does not change. Torvalds's account is gathered from developers and through the head start given to cheap infrastructure, not from users; and Git, a two-week side project, possibly weighs more in it than the kernel, because it shapes the programmer's working minute directly. Stallman shows the same split within one account: the content, the four freedoms, gave hundreds of Vitas; the form, the compiler and the licence, gave kilovitas.

## 3. The inventor of the game versus the player

Naismith is thirty kilovitas; Messi is four hundred Vitas at best. Wynne, Garns, Rubik, Pajitnov and Gygax are kilovitas; Carlsen is tens of Vitas. A player occupies a seat that someone else would have taken without him; the one who invented the game is irreplaceable in all of its minutes at once. The intern who wrote Solitaire is an order of magnitude ahead of the world chess champion.
...
Khufu is the reverse case: the name has lived for forty-five centuries, and the account is modest, hundreds of Vitas. If everyone alive has thought about him for at least two minutes, that is 640 Vitas of raw attention, and between one and six after degree and share: reach without degree weighs almost nothing. The account rests on other things: the builders and subjects in his lifetime, twenty years taken by force, the school and Egyptology, and those who make their living at the pyramid today — the guides and guards add up to as many as the builders once did. A year of fame comes to no more than a fifth of a Vita. The content — cult, power, faith — is lost, while the name survived because it became the label of a unique object. A text needs copyists, a custom needs an institution, and stone needs no one: it is a medium that does not have to be copied, the limit of [asynchrony](math.html). Duration and account are different things.

The pyramid as a place stands an order of magnitude above Khufu in the table of non-persons: these are the same minutes before division, and the difference between the rows is the pharaoh's share. Lenin's monuments show what stone cannot do: fourteen thousand statues, the most common street name in the country and the mausoleum together give less than a hundred Vitas. A glance at a pedestal is not a minute, and an address is not a thought. Lenin's account in megavitas rests not on bronze but on the form of state and party that two hundred million people carried in their heads for seventy years and China carries still.
...
## 7. Ripe inventions: head start or form

Gutenberg, Haber and Berners-Lee invented what was already ripening: without them others would have done the same within a few years or decades. There are two extreme ways to count this. By head start, a person gets only what happened earlier thanks to him: for Gutenberg that is one generation of readers of incunabula, less than a kilovita. By rigid shift, all later history runs late by the same span, and what is lost is the last twenty-five years of reading, a sizeable part of all printed minutes ever.

The [protocol](protocol.html) takes the middle. Under rule R6 the weight of a link without which the result would have happened anyway equals the fraction of the horizon lost to the delay: a generation out of six centuries gives Gutenberg about a twentieth, and after sharing with the other links, a few percent of the form of the medium. This is a convention, not a discovery: it silently assumes that a delay is neither made up nor amplified. The rows of the table are counted by it.

ChatGPT is a fresh case of the same rule. The raw estimate of the product as a medium is 7–22 kVt, and under R6 less than three: a one-year lead over competitors on a thirty-year horizon gives a few percent of the channel. The content in a minute of an answer belongs not to the product but to the authors of the corpus: about 100 kVt has already passed through it to them, as much as through Wikipedia in twenty years. It is a re-emitter of the Anonymous, Gutenberg rather than Luther. The open question is what to do when a model begins to produce content that is not in the corpus: for now it counts as a channel, like a reteller.
