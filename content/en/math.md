...
The typical person who lived a full life accumulates about 0.2 Vt, and most never reach the threshold. The estimate comes from above, from the partition itself. People own h = 1 − s − n of every minute, on the order of 0.7. More than half of that goes along the chain to the Anonymous, a few percent to named authors, and about a third is left to close contemporaries: 0.7 × 0.3 ≈ 0.2. In a steady population, what is received from close people on average is what is given to them on average, and the close circle has no heavy tail, so the median sits near the mean. The interval is 0.1–0.3 Vt. The mean outgoing account over all people equals the mean incoming one, identically, by the conservation law; over everyone who ever lived it is less than a third of a Vita, because half died as children, having had time to receive but not to give. The distribution is skewed: most give less than they received, and the difference is held by the tail: the authors of language, norms and religions, most of them nameless.
